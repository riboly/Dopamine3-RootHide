...
- `3.0.34` protects exactly `/usr/libexec/thermalmonitord` from injection on iOS 18 and adds a bounded watchdog-created quarantine for reviewed dedicated Apple service paths. It is not device verified until activation, normal thermal behavior, package-manager regressions, and at least one full reboot/reactivation cycle pass.
