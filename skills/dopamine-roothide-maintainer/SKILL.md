...
- `3.0.33` is the packaging version for the restored network Frida installer and the manually dispatchable full-build workflow. It does not change the device-verified `neagent`/VPN fix.
